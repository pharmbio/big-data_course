...
\section{Storage}
    ...
    \begin{frame}
        ...
        \begin{block}{Databases}
            You are probably already familiar with relational databases like MySQL \textit{etc.}

            But when working with big data a relational databases is not always going to cope.
            ...
            big data, \textit{i.e.}, the noSQL databases.
        \end{block}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{block}{Not as complex as relational databases}
            Since the NoSQL databases are not as complex as relational
            databases they can sometimes handle big data much better, for
